...
var Ot;
const I = ((Ot = globalThis.__sveltekit_q0c58c) == null ? void 0 : Ot.base) ? ? "";
var jt;
const Re = ((jt = globalThis.__sveltekit_q0c58c) == null ? void 0 : jt.assets) ? ? I,
    Ie = "1708052637705",
...
async function K({
    ...
    if (Kt.length = 0, vt = !1, yt(d), Jt(m), f.props.page.url.pathname !== n.pathname && (n.pathname = f.props.page.url.pathname), i = e ? e.state : i, !e) {
        const p = o ? 0 : 1,
            y = {
                [$]: k += p,
                [F]: A += p,
...
function Je() {
    ...
    }), (n = navigator.connection) != null && n.saveData || ze(), L.addEventListener("click", e => {
        var g;
